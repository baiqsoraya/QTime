...
public class ProfileForm extends JFrame {
    ...
    private JButton submitbtn; // Button for submitting changes
    ...
    private void initComponents() {
        ...
        submitbtn = new JButton("Submit"); // Button to submit changes
        ...
        submitbtn.setVisible(false); // Initially set to invisible
