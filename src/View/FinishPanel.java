...
public class FinishPanel extends JPanel {
    ...
    public FinishPanel(String username) {
        ...
        this.highScore = databaseHandler.fetchHighScore(userId);
        this.timetotal = databaseHandler.fetchTotalTime(userId);
    ...
    public void adjustLayout(int frameWidth, int frameHeight) {
        ...
        // Set finishLabel position and font size
        int finishLabelX = (frameWidth - finishlabel.getWidth()) / 2;
        int finishLabelY = headerY + header.getHeight() + 104; // Menyesuaikan agar di atas pusat vertikal
        finishlabel.setLocation(finishLabelX, finishLabelY);

        // Set scoreLabel position and font size
        ...
        // Set attemptLabel position and font size
    ...
    private void initComponents() {
        ...
        homebtn.setFont(new Font("Segoe UI", 0, 14)); // NOI18N
        ...
        finishlabel.setFont(new Font("Segoe UI", 1, 24)); // NOI18N
        finishlabel.setText("Quiz Finish");

        scorelabel.setFont(new Font("Segoe UI", 0, 14)); // NOI18N
        scorelabel.setText("Score: "+highScore);

        timelabel.setFont(new Font("Segoe UI", 0, 14)); // NOI18N
        timelabel.setText("Time: "+timetotal);

        attemptlabel.setFont(new Font("Segoe UI", 0, 14)); // NOI18N
